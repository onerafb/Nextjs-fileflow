    ...
    <div className={styles.home_section}>
      <div className={styles.container}>
        <div className={styles.h1_div}>
          <h1 className={styles.h1_home}>
            Upload,Save and easily Share your file in one place.
          </h1>
        </div>
      ...
      <div className={styles.custom_shape_divider_bottom_1703239618}>
        <svg
          data-name="Layer 1"
      ...
      <div className={styles.custom_shape_divider_bottom_1703239899}>
        <svg
          data-name="Layer 1"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 1200 120"
